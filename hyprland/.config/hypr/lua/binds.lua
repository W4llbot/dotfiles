...
hl.bind("ALT + PRINT", hl.dsp.exec_cmd(screenshotWindow))

-- Colorpicker
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(colorPicker))
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd(colorPickerRGB))

-- Idle and locks
hl.bind(mainMod .. " + CONTROL + SHIFT + l", hl.dsp.exec_cmd(lock))
...
-- Blue light filter
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("pkill " .. bluefilter .. " || " .. bluefilter .. " --temperature 3500"))
