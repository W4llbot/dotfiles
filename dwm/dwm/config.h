...
static const char *volup[] = { "pactl", "set-sink-volume", "0", "+3%", NULL };
static const char *voldown[] = { "pactl", "set-sink-volume", "0", "-3%", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
 	...
 	// { MODKEY|ShiftMask,              XK_9,      incrgaps,       {.i =  1 } },
 	// { MODKEY|ShiftMask,              XK_8,      incrgaps,       {.i = -1 } },
